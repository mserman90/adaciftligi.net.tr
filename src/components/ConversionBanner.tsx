          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-4 flex flex-col gap-3.5">
              <button
                ...
                className="w-full bg-white hover:bg-stone-100 text-[#123c28] font-bold text-base py-4 px-6 rounded-full shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center gap-2.5 active:scale-98"
              >
